<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register_doctor') }}">
            @csrf
            ...
            <div>
                <x-jet-label for="especialidad" value="{{ __('Teléfono') }}" />
                <x-jet-input id="especialidad" class="block mt-1 w-full" type="text" name="especialidad" :value="old('especialidad')" required autofocus autocomplete="especialidad" />
            </div>
